...
pacman -S dolphin konsole kdegraphics-okular iw wireless_tools alsa-utils nvidia-dkms crda plasma-meta linux-headers xorg-server xorg-server-utils --noconfirm
